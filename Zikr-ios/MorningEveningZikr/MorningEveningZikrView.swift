    ...
    var body: some View {
        Form {
            Section {
                ...
                HStack {
                    Text("\(morningEveningZikr.count) марта")
                    Spacer()
                    Text(morningEveningZikr.source)
                }
            }
            ...
            if morningEveningZikr.isQuran == false {
                Section {
